...
const notificationServices = {
   ...
   * Handled by NotificationApiController
   */
  ...
  /**
   * Full Notification Management (user/notifications)
   * Handled by AllNotificationApi
   */
  ...
  userMarkRead: async (ids: (string | number)[]) => {
    try {
      // Logic check: ensure we aren't sending an empty array
